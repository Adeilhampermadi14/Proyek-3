...
export const MPermintaan = ({ toggleClose }) => {
  ...
  const getData = () => {
    ...
    Promise.all([
      fetchData(`${process.env.REACT_APP_API_URL}/mahasiswa/dosen`),
      fetchData(`${process.env.REACT_APP_API_URL}/mahasiswa/kompetensi`),
      fetchData(`${process.env.REACT_APP_API_URL}/mahasiswa/ruangan`),
      fetchData(`${process.env.REACT_APP_API_URL}/mahasiswa/jam`),
    ]).then(([dosen, kompetensi, ruangan, jam]) => {
      setdata({
        dosen: dosen,
  ...
  const handleSubmit = (e) => {
    ...
    console.log(data);
    axios
      .post(`${process.env.REACT_APP_API_URL}/mahasiswa/permintaan/add`, Form, {
        headers: { Authorization: `Bearer ${Cookies.get("accessToken")}` },
      })
      .then((res) => {
        dispatch(
