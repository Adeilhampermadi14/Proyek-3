...
export const MKelolaKompetensi = ({ toggleClose }) => {
  const [Form, setForm] = useState({
    nama_kompetensi: null,
  });
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    axios
      .post(`${process.env.REACT_APP_API_URL}/admin/kompetensi/add`, Form,{headers:{Authorization: `Bearer ${Cookies.get('accessToken')}`}})
      .then((res) => {
        dispatch(
